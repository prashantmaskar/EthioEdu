    ...
    function edit_project_topic()
       {
             $config['upload_path']          = './uploads/Documents';
                ...
                if ( ! $this->upload->do_upload('format_type'))
                {
                ...
                else
                {
                  ...
                  'project_course'  => $this->input->post('email'),
                  'project_year'=>$this->input->post('contact'),
                  'project_format'=>  $this->input->post('catagory'),
