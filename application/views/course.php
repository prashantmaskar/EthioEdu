                            ...
                            <div class="school_category_box">
                                ...
                                <?php foreach($cat as $row){
                                   ...
                                   $query2 = $this->db->query("select count(*) as row_count from tbl_course where course_category = '".$cc_name."' and course_approve = '1' GROUP BY course_category ");
                                    ...
                                    <li class="catrgory_list_item"><a href="<?php echo base_url(); ?>index.php/course/search?category=<?php echo $cc_name; ?>"><?php echo $cc_name; ?> (<?php echo $query2->result()[0]->row_count; ?>)</a></li>
                                    <?php } ?>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="course_search_result">
                        <div class="row">
                            <div class="col m12 s12">
                                ...
                                <?php $c_id = substr(md5($row->course_id),0,6)."$".$row->course_id;
                                        ?>
                                    <a href="<?php echo base_url().'index.php/coursedetails?id='.$c_id ?>" class="collection-item s col s12"><?php echo $row->course_name; ?>
