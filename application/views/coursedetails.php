                                    ...
                                    <li><a href="#" class="waves-effect waves-light btn googleplus darken-3"><i class="fa fa-google-plus"></i> Google</a></li>  -->
                                     <ul>
                                      <?php  foreach ($course_details as $row){ ?>
                                            ...
                                            $course_desc = substr($row['course_desc'],0,100);
                                             $edesc = $course_desc.'...';
                                            ?>
                                            <li><a target="_blank" href="javascript:myPopup('https://www.linkedin.com/shareArticle?mini=true&url=<?php echo base_url();?>?id=<?php echo $_GET['id'] ?>&title=<?php echo $row['course_name']; ?>&summary=<?php echo $edesc; ?>')" class="waves-effect waves-light btn linkedin darken-3"><i class="fa fa-linkedin"></i> Linkedin</a></li> 

                                            <li><a href="https://twitter.com/intent/tweet?text=<?php echo $row['course_name']?>?url=<?php echo base_url();?>?id=<?php echo $_GET['id'] ?>" data-show-count="false" class="waves-effect waves-light btn twitter darken-3 "><i class="fa fa-twitter"></i> Twitter</a></li> 
